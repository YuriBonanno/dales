...
!Important Routine
	...
	subroutine findGLQPoints()
		...
		call writeinttofile("n_GLQ_clear", n_GLQ_clear, 1, 1, 1, 1)
		call writeinttofile("n_GLQ_cloudtop", n_GLQ_cloudtop, 1, 1, 1, 1)
		call writeinttofile("n_clear", n_clear, 1, 1, 1, 1)
		call writeinttofile("n_clouds", n_clouds, 1, 1, 1, 1)
		call writeinttofile("n_classes", n_classes, 1, 1, 1, 1)
		call writeinttofile("class_size", class_size, 1, 1, 1, 1)
